...
// One click builds the whole playable Checkpoint-1 scene from the Kenney
...
//
// USAGE:  Tools ▸ Graveyard Keeper ▸ Build World (Checkpoint 1)
//
...
public static class GraveyardWorldBuilder
{
    ...
    [MenuItem("Tools/Graveyard Keeper/Build World (Checkpoint 1)")]
    public static void BuildWorld()
    {
        ...
        BuildHUD(gm, cam.transform, minimapRT);
        ...
        EditorUtility.DisplayDialog("Graveyard Keeper",
            "Endless world built!\n\nPress Play to test.\n\n" +
            "Controls: WASD move · Mouse look · Shift sprint · E harvest · Left-click attack · Esc free cursor.\n\n" +
            "The graveyard streams around you endlessly. Next: run\n" +
            "Tools ▸ Graveyard Keeper ▸ Setup Axe Pack Character for the animated hero.",
            "OK");
    }
    ...
    // ── HUD (M6.4 + M7.2) ───────────────────────────────────────────────────────
    static void BuildHUD(GraveyardManager gm, Transform cam, RenderTexture minimapRT)
    {
        ...
        gm.banishText  = Text("Spirits",  C, new Vector2(0,1), new Vector2(30,-174), new Vector2(340,44), 28, TextAlignmentOptions.Left, new Color(0.7f,0.85f,1f));
